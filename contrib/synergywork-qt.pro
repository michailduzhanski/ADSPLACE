...
RESOURCES += src/qt/adsplace.qrc src/qt/adsplace_locale.qrc

TRANSLATIONS += src/qt/locale/adsplace_bg.ts \
                src/qt/locale/adsplace_de.ts \
                src/qt/locale/adsplace_en.ts \
                src/qt/locale/adsplace_es.ts \
                src/qt/locale/adsplace_fi.ts \
                src/qt/locale/adsplace_fr.ts \
                src/qt/locale/adsplace_it.ts \
                src/qt/locale/adsplace_ja.ts \
                src/qt/locale/adsplace_pl.ts \
                src/qt/locale/adsplace_pt.ts \
                src/qt/locale/adsplace_ru.ts \
                src/qt/locale/adsplace_sk.ts \
                src/qt/locale/adsplace_sv.ts \
                src/qt/locale/adsplace_vi.ts \
                src/qt/locale/adsplace_zh_CN.ts \
                src/qt/locale/adsplace_zh_TW.ts
