Contributing to ADSPLACE Core
============================

The ADSPLACE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ADSPLACE Core project, and is not to be
confused with overall ADSPLACE Network Protocol consensus changes.

Whether a pull request is merged into ADSPLACE Core rests with the project merge
...
Patches that change ADSPLACE consensus rules are considerably more involved than
...
Where a patch set proposes to change the ADSPLACE consensus, it must have been
...
The project leader is the release manager for each ADSPLACE Core release.
