...
This mechanism has been integrated into Bitcore-Node-ADSPLACE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ADSPLACE-Project/insight-api-adsplace#web-socket-api](https://github.com/ADSPLACE-Project/insight-api-adsplace#web-socket-api) 
* API: [https://github.com/ADSPLACE-Project/insight-api-adsplace#swifttx-transactions](https://github.com/ADSPLACE-Project/insight-api-adsplace#swifttx-transactions) 
...
By default, the ADSPLACE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ADSPLACE Core daemon:
