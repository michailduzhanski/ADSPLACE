...
In order to support loading of multiple wallets in adsplace-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adsplace.cpp.
...
Changes to adsplace.cpp
----------------------
adsplace.cpp is the entry point into adsplace-qt, and as such, will require some minor modifications to provide hooks for
