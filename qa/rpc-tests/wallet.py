...
#   c) node1 mines 32 blocks, so now node 0 has 60001ADS, node 1 has 4250ADS, node2 has none.
#   d) node0 sends 601 ADS to node2, in two transactions (301 ADS, then 300 ADS).
