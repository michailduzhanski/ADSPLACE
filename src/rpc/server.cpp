...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ADSPLACE server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ADSPLACE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ADSPLACE features */
        {"adsplace", "masternode", &masternode, true, true, false},
        {"adsplace", "listmasternodes", &listmasternodes, true, true, false},
        {"adsplace", "getmasternodecount", &getmasternodecount, true, true, false},
        {"adsplace", "masternodeconnect", &masternodeconnect, true, true, false},
        {"adsplace", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"adsplace", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"adsplace", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"adsplace", "masternodecurrent", &masternodecurrent, true, true, false},
        {"adsplace", "masternodedebug", &masternodedebug, true, true, false},
        {"adsplace", "startmasternode", &startmasternode, true, true, false},
        {"adsplace", "createmasternodekey", &createmasternodekey, true, true, false},
        {"adsplace", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"adsplace", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"adsplace", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"adsplace", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"adsplace", "getmasternodescores", &getmasternodescores, true, true, false},
        {"adsplace", "mnbudget", &mnbudget, true, true, false},
        {"adsplace", "preparebudget", &preparebudget, true, true, false},
        {"adsplace", "submitbudget", &submitbudget, true, true, false},
        {"adsplace", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"adsplace", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"adsplace", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"adsplace", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"adsplace", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"adsplace", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"adsplace", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"adsplace", "checkbudgets", &checkbudgets, true, true, false},
        {"adsplace", "mnsync", &mnsync, true, true, false},
        {"adsplace", "spork", &spork, true, true, false},
        {"adsplace", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzADSseed", &getzADSseed, false, false, true},
        {"zerocoin", "setzADSseed", &setzADSseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzADS", &searchdzADS, false, false, true},
        {"zerocoin", "dzADSstate", &dzADSstate, false, false, true}
...
{
    return "> adsplace-cli " + methodname + " " + args + "\n";
}
