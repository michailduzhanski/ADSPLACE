...
/**
 * ADSPLACE RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzADSseed(const UniValue& params, bool fHelp);
extern UniValue getzADSseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzADS(const UniValue& params, bool fHelp);
extern UniValue dzADSstate(const UniValue& params, bool fHelp);
