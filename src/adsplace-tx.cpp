...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Adsplace Core adsplace-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  adsplace-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adsplace transaction") + "\n" +
                               "  adsplace-tx [options] -create [commands]   " + _("Create hex-encoded adsplace transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded adsplace transaction
