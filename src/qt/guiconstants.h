...
/* Adsplace GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ADSPLACE"
#define QAPP_ORG_DOMAIN "synergy-work.com"
#define QAPP_APP_NAME_DEFAULT "ADSPLACE-Qt"
#define QAPP_APP_NAME_TESTNET "ADSPLACE-Qt-testnet"
