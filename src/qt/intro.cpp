...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ADSPLACE Core"),
     ...
     * override -datadir in the adsplace.conf file in the default data directory
     * (to be consistent with adsplaced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
