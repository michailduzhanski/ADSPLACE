                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzADSPathCustom = GetArg("-zADSbackuppath", "");
    ...
    if(!strzADSPathCustom.empty()) {
        ui->wallet_customzADSbackuppath->setText(QString::fromStdString(strzADSPathCustom));
        ui->wallet_customzADSbackuppath_label->setVisible(true);
        ui->wallet_customzADSbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzADSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ADSPLACE RPC console.") + "<br>" +
