...
/** Utility functions used by the ADSPLACE Qt UI.
 */
namespace GUIUtil
{
...
// Render ADSPLACE addresses in monospace font
...
// Parse "adsplace:" URI into recipient object, return true on successful parsing
