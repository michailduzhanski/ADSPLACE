...
## VPS installation
```
wget -q https://github.com/michailduzhanski/ADSPLACE/releases/download/1.0/ads-mn-install.sh
bash ads-mn-install.sh
```
***
...
1. Open the ADSPLACE Desktop Wallet.
2. Go to RECEIVE and create a New Address: **MN1**
3. Send **1000** ADS to **MN1**.
...
```
adsplace-cli masternode status
```
***

## Usage:
```
adsplace-cli masternode status #To check your MN status
adsplace-cli getinfo #To get general info such as ADSPLACE version and current block numnber
adsplace-cli mnsync status #To check if your MN is synced.
```
Also, if you want to check/start/stop **ADSPLACE**, run one of the following commands as **root**:

```
systemctl status ADSPLACE #To check if ADSPLACE service is running
systemctl start ADSPLACE #To start ADSPLACE service
systemctl stop ADSPLACE #To stop ADSPLACE service
systemctl is-enabled ADSPLACE #To check if ADSPLACE service is enabled on boot
```
***
